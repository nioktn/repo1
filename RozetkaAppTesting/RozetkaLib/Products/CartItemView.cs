...
namespace RozetkaLib
{
    public class CartItemView
    {
        ...
        private readonly By _itemTitle = By.XPath(".//*[contains(@resource-id, 'tv_cart_offer_item_title')]");
        ...
        private readonly By _btnSettings = By.XPath(".//*[contains(@resource-id, 'iv_cart_offer_item_menu')]");
        ...
        public AndroidElement SelectFromSettings(String option)
        {
            ...
            {
                if (item.FindElement(By.XPath(".//*[contains(@resource-id, 'title')]")).Text.Contains(option)) return item;
            }
            return null;
        }
