...
namespace RozetkaLib
{
    class FilterPanel
    {
        ...
        //    private AndroidElement RbtnCheapExpensive { get => driver.FindElement(_rbtnCheapExpensive); }
        //    private AndroidElement RbtnExpensiveCheap { get => driver.FindElement(_rbtnExpensiveCheap); }
        //    private AndroidElement RbtnPopular { get => driver.FindElement(_rbtnPopular); }
        //    private AndroidElement RbtNovelty { get => driver.FindElement(_rbtNovelty); }
        //    private AndroidElement RbtnShares { get => driver.FindElement(_rbtnShares); }
        //    private AndroidElement RbtnByRate { get => driver.FindElement(_rbtnByRate); }

        public FilterPanel(AndroidDriver<AndroidElement> driver)
        {
            this.driver = driver;
        }
        ...
        //{
        //    return ElemHelper.IsElementVisible(driver, _rbtnByRate);
        //}
